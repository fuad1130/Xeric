        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto">
          ...
          <div className="space-y-8 text-center lg:text-left">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 pt-8 max-w-2xl lg:mx-0 mx-auto">
              ...
              <div className="text-center lg:text-left">
                <div className="text-2xl lg:text-3xl font-bold text-primary mb-1">2018</div>
                <div className="text-sm text-foreground/60 font-medium">Established</div>
              </div>
              
              <div className="text-center lg:text-left">
                <div className="text-2xl lg:text-3xl font-bold text-primary mb-1">ISO</div>
                <div className="text-sm text-foreground/60 font-medium">Certified</div>
              </div>
              
              <div className="text-center lg:text-left">
                <div className="text-2xl lg:text-3xl font-bold text-primary mb-1">MENA</div>
